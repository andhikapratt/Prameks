...
class LvAdapterMyTrips(private val context: MyTrips,
                       ...
                       private val harga: ArrayList<String>,
                       private val hari: ArrayList<String>) : ArrayAdapter<String>(context, R.layout.lv_mytrips, kd_booking){
    override fun getView(position: Int, view: View?, parent: ViewGroup): View {
        ...
        val hargaa = rowView.findViewById(R.id.tv_harga) as TextView
        val harii = rowView.findViewById(R.id.tv_hari) as TextView
